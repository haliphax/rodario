...
latex_documents = [
  (master_doc, 'rodario.tex', u'rodario Documentation',
   u'haliphax', 'manual'),
]
...
man_pages = [
    (master_doc, 'rodario', u'rodario Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'rodario', u'rodario Documentation',
   author, 'rodario', 'One line description of project.',
   'Miscellaneous'),
]
